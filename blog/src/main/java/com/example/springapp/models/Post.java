...
public class Post implements Serializable {
    ...
    /*public Post(HashMap<String, Object> data) {
        ...
        keys.forEach(key -> {
            switch (key) {
                case "posts_id": this.posts_id = (int) data.get("posts_id"); break;
                case "title": this.title = (String) data.get("title"); break;
                case "content": this.content = (String) data.get("content"); break;
                case "category": this.category = (String) data.get("category"); break;
                case "main_image": this.main_image = (String) data.get("main_image"); break;
