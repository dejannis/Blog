...
public class AdminPostsController {
    ...
    public @ResponseBody void newPostSubmit(@ModelAttribute("title") String title, @ModelAttribute("content") String content,
    ...
    public @ResponseBody void delete(@PathVariable int post_id, HttpServletResponse response) throws SQLException {
    ...
    @GetMapping(value = "/admin/posts/edit/{post_id}")
    ...
    @PostMapping(value = "/admin/posts/edit/{post_id}")
    public @ResponseBody void edit_post_submit(@PathVariable int post_id, @ModelAttribute("title") String title,
                                                 @ModelAttribute("content") String content,
                                                 @ModelAttribute("category") String category, HttpServletResponse response) throws SQLException {
        Post p = new Post();
