...
public class AdminLoginController {
    ...
    public @ResponseBody void login_submit(@ModelAttribute("username") String username, @ModelAttribute("password") String password,
    ...
    public @ResponseBody void logout(HttpSession session, HttpServletResponse response) {
